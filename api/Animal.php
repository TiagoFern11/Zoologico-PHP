...
WHERE animal.Id_animal='".$_GET["id_animal"]."'";
    ...
    <body>
        ...
        <div class="slideshow-container">
            ...
            echo "<div class='mySlides fade'>";
                echo "<img class='img-slide-1' src='$im'>";
            echo "</div>";
            //echo $imag["Imagem"]."<br>";
        ...
        <div class="centro-pagina">
            <table class="tabela-botoes-extincao">
                <tr>
                    ...
                    switch ($nivel){
                        case "Não Avaliada":
                            echo "<th class='espaco-botoes-extincao extincao-ativo'>Não Avaliada</th>";
                        ...
                        case "Pouco Preocupante":
                            echo "<th class='espaco-botoes-extincao'>Não Avaliada</th>";
        ...
        <div class="centro-pagina" style="margin-top: 10px;">
            ...
            <div class="informacoes-secundarias">
                ...
                <a href="Apadrinhar.php" class="botao-classes centro">Apadrinhar Animal</a>
